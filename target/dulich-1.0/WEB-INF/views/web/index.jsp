 ...
 <section class="banner">
            ...
            <div class="container">
                <div class="banner-cn">
                    <div class="logo-banner text-center">
                        <a href="#" title="">
                            <img src="<c:url value='/template/web/images/logo-banner.png'/>" alt="">
                        </a>
                    </div>
                    <div class="category-singer clearfix">
                        <div class="cate-singer-icon float-left">
                            <h2>Tour</h2>
                            <img src="<c:url value='/template/web/images/icon-vacation.png'/>" alt="">
                        </div>
                        <p>Hơn <span>150,000</span> tour cho bạn lựa chọn</p>
                    </div>
                    <div class="form-cn form-tour">
                        <h2>Bạn muốn đi đâu?</h2>
                        <div class="form-search clearfix">
                            <div class="form-field field-select field-region">
                            <!-- <input class="select" placeholder="điểm đến"></input> -->
                                <div class="select">
                                    <span>Điểm đến: <small>Đà nẵng, Nha trang..</small></span>
                                    <select>
            ...
            <div class="title-wrap">
                <div class="container">
                    <div class="travel-title float-left">
                        <h2>Ưu đãi trong tuần:<span> Paris, Amsterdam, Saint Petersburg &amp; more</span></h2>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="cruise-deals-cn clearfix">
                        ...
                        <div class="cruise-deal-item">
                            <figure class="cruise-img">
                                <a href="tour-detail.html" title="">
                                    <img src="<c:url value='/template/web/images/deal/img-5.jpg'/>" alt="">
                                </a>
                            </figure>
                    ...
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            <figure class="cruise-img">
                                <a href="tour-detail.html" title="">
                                    <img src="<c:url value='/template/web/images/deal/img-6.jpg'/>"  alt="">
                                </a>
                            </figure>
                            <div class="cruise-text">
                                <div class="cruise-name">
                    ...
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            <figure class="cruise-img">
                                <a href="tour-detail.html" title="">
                                    <img src="<c:url value='/template/web/images/deal/img-7.jpg'/>" alt="">
                                </a>
                            </figure>
                            <div class="cruise-text">
                                <div class="cruise-name">
                    ...
                    <div class="col-xs-6 col-md-4 col-lg-3">
                        <div class="cruise-deal-item">
                            <figure class="cruise-img">
                                <a href="tour-detail.html" title="">
                                    <img src="<c:url value='/template/web/images/deal/img-8.jpg'/>" alt="">
                                </a>
                            </figure>
                            <div class="cruise-text">
                                <div class="cruise-name">
        ...
        <section class="destinations">
            <div class="title-wrap">
                <div class="container">
                    <div class="travel-title float-left">
                        <h2>Điểm đến du lịch hàng đầu</h2>
                    </div>
                    <a href="#" title="" class="awe-btn awe-btn-5 arrow-right awe-btn-lager text-uppercase float-right">Xem thêm</a>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-3">
                            <div class="intro-filter">
                                <div class="intro">
                                    <p>
                                        <small>Khám phá</small><br>
                                        <span>2364</span> điểm đến
                                    </p>
                                    <p>
                                        <small>Với</small><br>
                                        <span>152,364</span> khách sạn
                                    </p>
                                </div>
                                <ul class="filter">
                                    <li class="active">
                                        <a data-toggle="tab" href="#destinations-1"><i class="fa fa-map-marker"></i> Đề xuất cho bạn</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a data-toggle="tab" href="#destinations-6"><i class="fa fa-map-marker"></i> Phần còn lại của thế giới</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div id="destinations-1" class="clearfix tab-pane fade active in ">
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="destinations-item ">
                                            ...
                                            <figure class="destinations-img">
                                                <a href="#" title="">
                                                    <img src="<c:url value='/template/web/images/destinations/img-1.jpg'/>" alt="">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="destinations-item">
                                            ...
                                            <figure class="destinations-img">
                                                <a href="#" title="">
                                                    <img src="<c:url value='/template/web/images/destinations/img-2.jpg'/>" alt="">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="destinations-item">
                                            ...
                                            <figure class="destinations-img">
                                                <a href="#" title="">
                                                    <img src="<c:url value='/template/web/images/destinations/img-3.jpg'/>" alt="">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="destinations-item">
                                            ...
                                            <figure class="destinations-img">
                                                <a href="#" title="">
                                                    <img src="<c:url value='/template/web/images/destinations/img-4.jpg'/>" alt="">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="destinations-item">
                                            ...
                                            <figure class="destinations-img">
                                                <a href="#" title="">
                                                    <img src="<c:url value='/template/web/images/destinations/img-5.jpg'/>" alt="">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-4 col-md-6 col-lg-4">
                                        <div class="destinations-item">
                                            ...
                                            <figure class="destinations-img">
                                                <a href="#" title="">
                                                    <img src="<c:url value='/template/web/images/destinations/img-6.jpg'/>" alt="">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                       ...
                       <div class="col-lg-6">
                            <div class="magazine-ds">
                                <div id="owl-magazine-ds" class="owl-carousel owl-theme" style="display: block; opacity: 1;">
                                    <!-- Magazine Descript Item -->
                                    <div class="owl-wrapper-outer"><div class="owl-wrapper" style="display: block; width: 4200px; left: 0px; transition: all 0ms ease 0s; transform: translate3d(0px, 0px, 0px);"><div class="owl-item active" style="width: 525px;"><div class="magazine-item">
                            ...
                            <div class="magazine-thum" id="magazine-thum">
                                ...
                                <div class="thumnail-item clearfix active">
                                    <figure class="float-left">
                                        <img src="<c:url value='/template/web/images/magazine/img-1.jpg'/>" alt="">
                                    </figure>
                                ...
                                <div class="thumnail-item clearfix">
                                    <figure class="float-left">
                                        <img src="<c:url value='/template/web/images/magazine/img-2.jpg'/>" alt="">
                                    </figure>
                                    <div class="thumnail-text">
                                        <h4>Thailand by Train with Eastern and Oriental Express</h4>
                                        <span>03.5.2014</span>
                                ...
                                <div class="thumnail-item clearfix">
                                    <figure class="float-left">
                                        <img src="<c:url value='/template/web/images/magazine/img-3.jpg'/>" alt="">
                                    </figure>
                                    <div class="thumnail-text">
                                        <h4>Thailand by Train with Eastern and Oriental Express</h4>
                                        <span>03.5.2014</span>
                                ...
                                <div class="thumnail-item clearfix">
                                    <figure class="float-left">
                                        <img src="<c:url value='/template/web/images/magazine/img-4.jpg'/>" alt="">
                                    </figure>
                                    <div class="thumnail-text">
                                        <h4>Thailand by Train with Eastern and Oriental Express</h4>
                                        <span>03.5.2014</span>
        ...
        <div class="bg-parallax bg-3" style="background-position: 50% 25px;"></div>
            <div class="container">
                <div class="row cs-sb-cn">
                    <div class="col-md-6">
                        <div class="confidence">
                            <h3>Đặt tour với niềm tin</h3>
                            <ul>
                                <li>
                                    <span class="label-nb">01</span>
                                    <h5>Không có phí đặt tour</h5>
                                    <p>Chúng tôi không tính thêm phí khi đặt tour của chúng tôi</p>
                                </li>
                                <li>
                                    <span class="label-nb">02</span>
                                    <h5>Không có phí hủy</h5>
                                    <p>Chúng tôi không tính phí hủy hoặc sửa đổi trong trường hợp kế hoạch thay đổi</p>
                                </li>
                                <li>
                                    <span class="label-nb">03</span>
                                    <h5>Chứng nhận tức thì</h5>
                                    <p>Xác nhận đặt tour ngay lập tức cho dù đặt trực tuyến hoặc qua điện thoại</p>
                                </li>
                                <li>
                                    <span class="label-nb">04</span>
                                    <h5>Đặt Tour linh hoạt</h5>
                                    <p>Bạn có thể đặt trước cả năm cho đến khi bạn tham gia tour</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="subscribe">
                            ...
                            <p>Nhập địa chỉ email của bạn và chúng tôi sẽ gửi cho bạn các email quảng cáo thường xuyên của chúng tôi, được đóng gói với các ưu đãi đặc biệt, ưu đãi lớn và giảm giá lớn</p>
                            <div class="subscribe-form">
                                <form action="#" method="get">
                                    <input type="text" name="" value="" placeholder="Your email" class="subscribe-input">
                                    <button type="submit" class="awe-btn awe-btn-5 arrow-right text-uppercase awe-btn-lager">theo dõi</button>
                                </form>
                            </div>
                            <div class="follow-us">
                                <h4>Follow us</h4>
